      ...
      >
        <div className="flex gap-4 m-auto">
          ...
          <button
            ...
            className="h-[60px] w-[350px] min-w-[350px] cursor-pointer rounded-lg bg-mainBackground border-2 border-columnBackground p-4 ring-rose-500 hover:ring-2 flex gap-2"
          >
            <PlusIcons />
            Add Column
          </button>
